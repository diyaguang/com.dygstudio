...
public class BaseRepository<T,PK extends Serializable>{
    ...
    /**
     * 用于省略 Dao 层，在 Service层直接使用通用的 BaseRepository 的构造函数，在构造函数中定义对象类型 Class
     * eg. BaseRepository<User,Long> userDao = new SimpleHibernateDao<user,Long>(sessionFactory,User.class)
     */
    public BaseRepository(final SessionFactory sessionFactory,final Class<T> entityClass){
